package com.edrisa.geoglemapsgeofire;
...
public class GeoFireActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    // object or in the same activity which contains the mapview.
        Mapbox.getInstance(this, getString(R.string.mapbox_map_auth_token));
...
*/
    ...
    private static class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<GeoFireActivity> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(GeoFireActivity activity) {
        ...
        public void onSuccess(LocationEngineResult result) {
            GeoFireActivity activity = activityWeakReference.get();
